...
See the full [Vector Store example and tutorial](https://gitlab.com/shidfar/langchaingo/tree/main/examples/google-alloydb-vectorstore-example).
...
import (
  ...
  "gitlab.com/shidfar/langchaingo/vectorstores/alloydb"
)
