...
func parseFlags() Config {
	...
	flag.StringVar(&config.PkgGoDevURL, "pkg-url", "https://pkg.go.dev/gitlab.com/shidfar/langchaingo", "pkg.go.dev base URL")
	flag.StringVar(&config.ModulePath, "module", "gitlab.com/shidfar/langchaingo", "Go module path")
