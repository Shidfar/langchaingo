...
```go
import "gitlab.com/shidfar/langchaingo/llms/openai"
...
```go
import "gitlab.com/shidfar/langchaingo/llms/anthropic"
...
```go
import "gitlab.com/shidfar/langchaingo/llms/ollama"
...
```go
import "gitlab.com/shidfar/langchaingo/llms/huggingface"
