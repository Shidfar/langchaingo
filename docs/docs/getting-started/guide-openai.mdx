...
```shell
go run gitlab.com/shidfar/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [openai-completion-example](https://gitlab.com/shidfar/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)):
