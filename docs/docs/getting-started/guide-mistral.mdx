...
```shell
go run gitlab.com/shidfar/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-completion-example](https://gitlab.com/shidfar/langchaingo/blob/main/examples/mistral-completion-example/mistral_completion_example.go)):
