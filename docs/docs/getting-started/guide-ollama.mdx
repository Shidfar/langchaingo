...
2. **Run the example**: Enter the command:
   ```shell
   go run gitlab.com/shidfar/langchaingo/examples/ollama-completion-example@main
   ```
...
Here is the entire program (from [ollama-completion-example](https://gitlab.com/shidfar/langchaingo/blob/main/examples/ollama-completion-example/ollama_completion_example.go)):
