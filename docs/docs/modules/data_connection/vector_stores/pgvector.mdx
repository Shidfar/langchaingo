...
Here is the entire program (from [pgvector-vectorstore-example](https://gitlab.com/shidfar/langchaingo/blob/main/examples/pgvector-vectorstore-example/pgvector_vectorstore_example.go)):
