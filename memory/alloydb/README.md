...
import (
  ...
  "gitlab.com/shidfar/langchaingo/internal/alloydbutil"
)
...
See the full [Chat Message History example and tutorial](https://gitlab.com/shidfar/langchaingo/tree/main/examples/google-alloydb-chat-message-history-example).
...
import (
  ...
  "gitlab.com/shidfar/langchaingo/memory/alloydb"
)
